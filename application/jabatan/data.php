...
class CRUD {
    ...
    function insertData($params) {
        ...
        if($numData > 0) {
            ...
            $sql .= " (kode_jabatan, nama_jabatan)";
            $sql .= " VALUES('".addslashes($params['kode'])."', "
                    . "'".  addslashes($params['jabatan'])."')";
    ...
    function updateData($params) {
        ...
        if($numData > 1) {
            ...
            $sql .= " SET kode_jabatan = '".addslashes($params['kode'])."', ";
            $sql .= " nama_jabatan = '".  addslashes($params['jabatan'])."'";
    ...
    function cekData($params) {
        ...
        $sql .= " WHERE kode_jabatan LIKE '%".addslashes($params['kode'])."%' AND "
                . "nama_jabatan LIKE '".addslashes($params['jabatan'])."'";
