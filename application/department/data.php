...
class CRUD {
    ...
    function updateData($params) {
        ...
        if($numData > 1) {
            ...
            $sql .= " SET kode_department = '".addslashes($params['kode'])."', ";
            $sql .= " nama_department = '".  addslashes($params['department'])."'";
    ...
    function cekData($params) {
        ...
        $sql .= " WHERE kode_department LIKE '%".addslashes($params['kode'])."%' OR "
                . "nama_department LIKE '%".addslashes($params['department'])."%'";
